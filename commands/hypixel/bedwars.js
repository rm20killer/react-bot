    ...
    hypixel
      ...
      .then((player) => {
        const embed = new Discord.MessageEmbed(base)
          ...
          .addField(
            "Coins",
            `\`${commaNumber(player.stats.bedwars.coins)}\``,
            true
          )
          .addField(
            "Winstreak",
          ...
          .addField(
            "Wins",
            `\`${commaNumber(player.stats.bedwars.wins)}\``,
            true
          )
          .addField(
            "Losses",
            `\`${commaNumber(player.stats.bedwars.losses)}\``,
            true
          )
          ...
          .addField(
            "Finals/Game",
            `\`${commaNumber(player.stats.bedwars.avg.finalKills)}\``,
            true
          )
          .addField(
            "Beds/Game",
            `\`${commaNumber(player.stats.bedwars.avg.bedsBroken)}\``,
            true
          )
          .addField(
            `Wins to ${commaNumber(
              Math.ceil(player.stats.bedwars.WLRatio)
            )} WLR`,
            `\`${commaNumber(
              player.stats.bedwars.losses *
                Math.ceil(player.stats.bedwars.WLRatio) -
          ...
          .addField(
            `Finals to ${commaNumber(
              Math.ceil(player.stats.bedwars.finalKDRatio)
            )} FKDR`,
            `\`${commaNumber(
          ...
          .addField(
            `Beds to ${commaNumber(
              Math.ceil(player.stats.bedwars.beds.BLRatio)
            )} BBLR`,
            `\`${commaNumber(
