    ...
    hypixel
      ...
      .then((player) => {
        const embed = new Discord.MessageEmbed(base)
          ...
          .addField(
            "Coins",
            `\`${commaNumber(player.stats.buildbattle.coins)}\``,
            true
          )
          .addField(
            "Total Wins",
            `\`${commaNumber(player.stats.buildbattle.winsTotal)}\``,
            true
          )
          .addField(
            "Total Games",
            `\`${commaNumber(player.stats.buildbattle.playedGames)}\``,
            true
          )
          .addField(
            "Total Votes",
            `\`${commaNumber(player.stats.buildbattle.totalVotes)}\``,
            true
          )
          .addField(
            "Score",
            `\`${commaNumber(player.stats.buildbattle.score)}\``,
            true
          )
          .addField(
            "Solo Wins",
            `\`${commaNumber(player.stats.buildbattle.wins.solo)}\``,
            true
          )
          .addField(
            "Team Wins",
            `\`${commaNumber(player.stats.buildbattle.wins.team)}\``,
            true
          )
          .addField(
            "Pro Wins",
            `\`${commaNumber(player.stats.buildbattle.wins.pro)}\``,
            true
          )
          .addField(
            "Guess That Build Wins",
            `\`${commaNumber(player.stats.buildbattle.wins.gtb)}\``,
            true
          );
