    ...
    if (
      ...
      if (args.length === 0) {
        const embed = new Discord.MessageEmbed()
          ...
          .setDescription(
            "want to be notified when a video is uploaded \n\nReact with the 🔔emote"
          )
          .setAuthor({
            name: "Gamers React",
            iconURL: "https://cdn.discordapp.com/emojis/764541981560537110.png",
          });
        ...
        if (args[0] === "notify") {
          ...
          const roleEmbed = new Discord.MessageEmbed()
            ...
            .setAuthor({
              name: "Gamers React",
              iconURL:
                "https://cdn.discordapp.com/emojis/764541981560537110.png",
            })
            .setColor("#ff0000")
            .setDescription(
              "React with the correct emoji to add or remove yourself from the notification list"
            )
