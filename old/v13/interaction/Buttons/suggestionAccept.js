...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        let suggestions = JSON.parse(fs.readFileSync("./utils/data/suggestions.json", "utf8"));
        if(categorie === "movie"){
        ...
        fs.writeFileSync("./utils/data/suggestions.json", JSON.stringify(suggestions, null, 2));
