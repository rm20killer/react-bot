    ...
    hypixel
      ...
      .then((player) => {
        const embed = new Discord.MessageEmbed(base)
          ...
          .addField(
            "Heads",
            `\`${commaNumber(player.stats.skywars.heads)}\``,
            true
          )
          ...
          .addField(
            "Coins",
            `\`${commaNumber(player.stats.skywars.coins)}\``,
            true
          )
          .addField(
            "Total Deaths",
          ...
          .addField(
            "Total Wins",
            `\`${commaNumber(player.stats.skywars.wins)}\``,
            true
          )
          .addField(
            "Tokens",
            `\`${commaNumber(player.stats.skywars.tokens)}\``,
            true
          )
          .addField("Prestige", `\`${player.stats.skywars.prestige}\``, true)
          .addField(
            "Souls",
            `\`${commaNumber(player.stats.skywars.souls)}\``,
            true
          )
          .addField(
            "Ranked Kills",
